...
public class StartQuizServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (subject == null || subject.isBlank() || quizTitle == null || quizTitle.isBlank()) {
        ...
        List<Question> questions = dao.getRandomQuestions(subject, quizTitle, QUESTIONS_PER_QUIZ);
        ...
        QuizSession quizSession = new QuizSession(subject, quizTitle, questions, DURATION_SECONDS);
