...
public class ResultDAO {
     ...
     */
    public int saveResult(int userId, String subject, String quizTitle, int score, int totalQuestions) {
        ...
        try {
            ...
            String sql = "INSERT INTO quiz_results (user_id, subject, quiz_title, score, total_questions) "
                       + "VALUES (?, ?, ?, ?, ?)";
    ...
    public List<QuizResult> getResultsBySubject(String subject) {
        ...
        try {
            ...
            String sql = "SELECT r.result_id, r.user_id, r.subject, r.quiz_title, r.score, "
            ...
            while (rs.next()) {
                results.add(mapRowWithUsername(rs));
            }
    ...
    /**
     * Used by admin/results.jsp - every student's result across every
     * subject, so the admin can see performance system-wide.
     */
    ...
    public List<QuizResult> getResultsByUser(int userId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                qr.setQuizTitle(rs.getString("quiz_title"));
    ...
    private QuizResult mapRowWithUsername(ResultSet rs) throws Exception {
