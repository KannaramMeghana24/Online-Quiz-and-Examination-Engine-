...
<label for="quizTitle">Quiz Title (e.g. "Quiz 1", "Photosynthesis Test")</label>
<input type="text" name="quizTitle" id="quizTitle" placeholder="Enter a name for this set of questions" required>
</div>
...
<script>
    ...
    function updateTracker() {
        ...
        var titleFilled = form.elements["quizTitle"].value.trim() !== "";
 
        tracker.textContent = completedCount + " / " + TOTAL + " completed";
 
        if (completedCount === TOTAL && titleFilled) {
