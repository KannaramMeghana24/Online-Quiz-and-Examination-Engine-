...
<a href="viewQuestions.jsp" style="display:inline-block;padding:10px 15px;background:#6c757d;color:white;text-decoration:none;border-radius:5px;margin-bottom:15px;margin-left:10px;">My Questions</a>
